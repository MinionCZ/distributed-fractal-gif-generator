...
class WorkStationManagementApiHandler(private val workStationManagementService: WorkStationManagementService) :
    ...
    override suspend fun join(request: WorkStation): Empty = workStationManagementService.join(request)


    override suspend fun leave(request: WorkStation): Empty = workStationManagementService.leave(request)
